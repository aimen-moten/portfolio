...
export function ProjectCard({ index, name, description, tags, image, source_code_link }) {
  return (
    <motion.div variants={fadeIn('up', 'spring', index * 0.5, 0.9)} animate={{ x: 100 }} initial={false}>
      <div className="bg-[#C9E6FB] rounded-2xl p-5 sm:w-[360px] w-full m-2">
        ...
        <div className="mt-5">
          ...
          <p className="text-black mt-2 text-[14px]">{description}</p>
        </div>
...
const Works = () => {
  return (
    <div className={`mx-auto  flow-root`} id="projects">
      ...
      <div className="w-full flex items-center justify-center">
        <motion.p variants={fadeIn('', '', 0.1, 1)} className="mt-3 text-white text-[20px] ">
