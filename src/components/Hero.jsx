...
const Hero = () => {
  ...
  return (
    <section className='relative w-full h-screen mx-auto'>
      <div className={`${styles.paddingX} absolute inset-0 top-[240px] max-w-7xl mx-auto flex flex-col sm:flex-row items-start gap-5`}>
        <div className='sm:flex-1'>
          ...
          <p className='whitespace-nowrap flex text-[30px]'>
            And I am&nbsp;
            {}
            <span className="whitespace-normal text-[#b2dcfa]">
              <Typewriter
                options={{
        ...
        {/* You can uncomment the following block to include the flex elements you need for your layout */}
